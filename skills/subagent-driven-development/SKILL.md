...
digraph process {
    ...
    subgraph cluster_per_task {
        ...
        "verification-before-completion" [shape=box style=filled fillcolor=lightyellow];
    ...
    "Implementer subagent implements, tests, commits, self-reviews" -> "verification-before-completion";
    "verification-before-completion" -> "Dispatch spec reviewer subagent (./spec-reviewer-prompt.md)";
