...
**Key Django apps:** `workspaces`, `fms` (file storage), `mvc` (model registry), `ams` (API serving), `cms` (containers), `accounts`, `sso`, `automl`, `model_garden`, `model_health`.

**RBAC:** Three view base classes — `ValidUserView`, `ValidWorkspaceUserView`, `AdminUserView`. Feature permissions declared in `libs/Constants.py`.
...
> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers-openspec:subagent-driven-development (recommended) or superpowers-openspec:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
- **REQUIRED SUB-SKILL:** Use superpowers-openspec:subagent-driven-development
- Fresh subagent per task + two-stage review

**If Inline Execution chosen:**
- **REQUIRED SUB-SKILL:** Use superpowers-openspec:executing-plans
